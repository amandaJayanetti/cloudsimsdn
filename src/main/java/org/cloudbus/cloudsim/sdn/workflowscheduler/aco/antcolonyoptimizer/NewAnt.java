...
public class NewAnt {
    ...
    public NewAnt(int tourSize, List<SDNVm> unallocatedVmList, List<SDNHost> hostList) {
    ...
    public NewAnt(int tourSize, List<SDNVm> unallocatedVmList, List<SDNHost> hostList, List<SDNHost> eligibleHosts, List<SDNHost> currClique) {
        this.trailSize = tourSize;
        this.unallocatedVmList = unallocatedVmList;
        this.hostList = hostList;
        this.allocMap = HashMultimap.create();
