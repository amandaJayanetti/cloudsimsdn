...
import org.cloudbus.cloudsim.sdn.workflowscheduler.aco.Ant;
import org.cloudbus.cloudsim.sdn.workflowscheduler.aco.AntColonyOptimization;
...
public class VmAllocationPolicyToTasks extends VmAllocationPolicy implements PowerUtilizationMaxHostInterface {
    ...
    public boolean allocateHostsForTask(Task task) {
        List<SDNVm> taskVms = task.getJobs();
        List<SDNHost> hostList = getHostList();

        AntColonyOptimization antColony = new AntColonyOptimization(hostList, taskVms, this);
