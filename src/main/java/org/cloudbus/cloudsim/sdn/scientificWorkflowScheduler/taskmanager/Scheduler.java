...
public class Scheduler {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            NetworkOperatingSystem nos = new NetworkOperatingSystemCustom();
...
//				break;
    ...
    public static void submitWorkloads(SDNCustomBroker broker) {
    ...
    protected static SDNDatacenter createSDNDatacenter(String name, String physicalTopology, NetworkOperatingSystem snos, VmAllocationPolicyFactory vmAllocationFactory) {
        ...
        try {
            ...
            VmAllocationPolicyToTasks taskVmPolicy = (VmAllocationPolicyToTasks) vmAllocationFactory.create(hostList);
            datacenter.setTaskVmAllocationPolicy(taskVmPolicy);
     ...
     */
    protected static SDNCustomBroker createBroker() {
        SDNCustomBroker broker = null;
        try {
            broker = new SDNCustomBroker("Broker");
        } catch (Exception e) {
            e.printStackTrace();
            return null;
        }
